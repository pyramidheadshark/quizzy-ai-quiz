...
def load_collection(file, card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback):
    ...
    update_card_content_callback(card_container, correct_count_label, incorrect_count_label, remaining_label)

# Функция для повторного прохождения ошибок
def retry_incorrect_cards(card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback):
...
def restart_collection(card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback):
...
def retry_incorrect_cards_ui(card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback):
    retry_incorrect_cards(card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback)

def restart_collection_ui(card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback):
    restart_collection(card_container, correct_count_label, incorrect_count_label, remaining_label, update_card_content_callback)
